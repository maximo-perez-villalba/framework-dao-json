...
[
    ...
    [
        ...
        'label' => "DAOJson::get-object-by-uid"
            ],
            'list' => 
    [
        'path' => "{$blocksPath}/list.php",
        'url' => "{$execUrlBase}list",
        'label' => "DAOJson::listByClass"
    ]
];
  	...
  	<div class="container-fluid">
  		<div class="row">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
            	<div class="container-fluid">
            		<a class="navbar-brand" href="/">Framework DAO / Json</a>
		...
		<div class="row">
                ...
                <footer class="bg-dark text-white">
                    <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                        <li class="nav-item">
                        	<a href="https://github.com/maximo-perez-villalba/framework-dao-json" target="_blank" class="nav-link px-2">
